...
def gerar_pdf_bytes(dados):
    ...
    def traduzir(cat):
        dic = {"Point of interest": "Ponto de interesse", "health": "Saúde", "ice_cream_shop": "Sorveteria", "snack_bar": "Lanchonete", "physiotherapist": "Fisioterapia", "lodging": "Hospedagem", "establishment": "Estabelecimento", "gym": "Academia", "store": "Comércio", "doctor": "Clínica", "beauty_salon": "Salão de Beleza", "cafe": "Café", "Store": "Loja", "motel": "Motel"}
