...
class PDF(FPDF):
    ...
    def footer(self):
        ...
        # Links individuais e centralizados
        page_w = self.epw
        self.set_x(10)
...
def gerar_pdf_estavel(dados, nome_empresa):
    ...
    # 1. Info Empresa (Bloco com altura dinâmica)
    ...
    # 3. Matriz de Diagnóstico (Posicionamento Relativo)
    pdf.set_y(y_c + h_b + 5)
    ...
    # 5. Final (Subi 1 linha, ln(6) aqui)
    pdf.ln(6)
