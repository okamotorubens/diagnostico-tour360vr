...
def gerar_pdf_bytes(dados):
    ...
    acoes = [
        ...
        ("2. FOMENTO À PROVA SOCIAL ORGÂNICA", "Estratégia para incentivar fotos de clientes reais, aumentando a autenticidade e o engajamento da ficha."),
        ("3. OTIMIZAÇÃO DE SEO LOCAL E CATEGORIAS", "Ajuste de categorias secundárias e palavras-chave para ampliar sua visibilidade orgânica regional."),
    ]
