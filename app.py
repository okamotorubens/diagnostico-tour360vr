...
# Função auxiliar para limpar texto e evitar erro "None"
...
def gerar_pdf_final(dados, nome_empresa):
    ...
    # Final (Subi 1 linha: era ln(10), agora ln(9))
    pdf.ln(9)
...
if btn and empresa and cidade:
    ...
    if res.get("results"):
        ...
        pdf_file = gerar_pdf_final(dados, empresa)
