...
nome_empresa_formatado = st.session_state['dados']['nome'].strip() if st.session_state['dados']['nome'] else 'Empresa'

st.download_button(
    label="📥 Baixar Diagnóstico, Proposta e Contrato Atualizados em PDF",
