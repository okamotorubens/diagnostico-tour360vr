...
# -----------------------------------------------------------------------------
# 5. SIDEBAR: NAVEGAÇÃO AJUSTADA PARA APONTAR PARA O NOVO NOME DE ARQUIVO
# -----------------------------------------------------------------------------
with st.sidebar:
    st.markdown("""
    ...
    # NAVEGAÇÃO CORRIGIDA PARA CORRESPONDER À URL AMIGÁVEL
    st.page_link("app.py", label="📋 Consultoria & Diagnóstico", icon="🔍")
    st.page_link("pages/CRM_Okamoto_Midias_Visuais.py", label="📊 CRM Okamoto Mídias Visuais", icon="🚀")
